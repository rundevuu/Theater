...
namespace Theater
{
    public partial class EnterCassirForm : Form
    {
        public EnterCassirForm()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (job.Count == 1)
                {
                    ...
                    {
                        MessageBox.Show("Вы не являетесь кассиром");
                    }
                    else
                    {
                        this.Hide();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (users.Count != 0)
            {
                ...
                SqlClass.Insert("INSERT INTO USERS(login,password, role) VALUES('" + login + "', '" + pasword + "', 'cassir')");
        ...
        private void EnterCassirForm_Load(object sender, EventArgs e)
        {
